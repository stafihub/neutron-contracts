...
echo "This ica address withdraw address is:"
query="$(printf '{"delegator_address":"%s"}' "$ica_address")"
grpcurl -plaintext -d $query localhost:9090 cosmos.distribution.v1beta1.Query/DelegatorWithdrawAddress | jq
